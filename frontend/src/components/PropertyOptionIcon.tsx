...
const PATHS: Record<PropertyOptionKey, string> = {
  AIR_CONDITIONER: 'M3 6h18v6H3zM6 15v2M10 15v2M14 15v2M18 15v2',
  REFRIGERATOR: 'M6 3h12v18H6zM6 10h12M9 6.5v1.5M9 13v2',
  WASHING_MACHINE: 'M4 3h16v18H4zM12 8a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9zM7 6h2',
  ...
  SHOE_CABINET: 'M3 16h6l4 2h8v2H3zM3 16V9a2 2 0 0 1 2-2h2l2 4',
  WARDROBE: 'M5 3h14v18H5zM12 3v18M9.5 11v2M14.5 11v2',
